...
export default function Hero(){
    ...
    return(
        <div className=" relative flex flex-col px-6 md:px-56 py-12 gap-12">
                ...
                <div className="flex flex-col items-center md:items-start flex-grow gap-4">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                        <div className="flex gap-4">
                             <a href="mailto:nikhildhanda84@gmail.com" className="text-stone-800 dark:text-stone-300 hover:opacity-70">
                                <GmailIcon />
                            </a>
            ...
            >
                ...
                <p className="max-w-3xl font-secondary mb-10 tracking-tighter text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
